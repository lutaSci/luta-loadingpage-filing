...
scope: `/global/zh-cn`, `/global/zh-tw`
visual_direction: `Quiet Field / 留白成境 v3`
release_scope: root-homepage release candidate; system-wide UI standard remains candidate
qa_status: release-scope visual acceptance and production authorization recorded; engineering and browser QA passed

> Current-status note: Pass 1–5 below are retained as historical baseline evidence. Pass 6 is the current implementation baseline. After reviewing that result, the user explicitly requested replacement of the production homepage and release on 2026-07-22. This records release-scope visual acceptance and production authorization, not completion of the five-person test or system-wide Token adoption; the broader UI-system `design_status` remains `candidate`.
...
- Implementation under test: local Vite development build at `/global/zh-cn` and `/global/zh-tw`, based on repository baseline `bf6bddc27be6cbdb0b583af6bf1fb2efad9edb8a`.
...
| Product visuals | pass for implementation; release-gated | Three real exported App UI images are used with explicit intrinsic dimensions, meaningful `alt`, eager hero loading and lazy below-fold loading. The source images are only 375 px and one home image contains a state overlay, so higher-density production derivatives are still required before release. |
...
- Four Figma-derived 375×812 assets have locally verified SHA-256 records: reading `ca76b87a450bc91df65d355c59a5084c86d3b5fe4588ab25593ae08c9ab52c41`, practice `32a205b16027e28f9d140d5ede1b37b2e974d5823e332b308696f037e6161a6c`, today wisdom `6a219cd7878ce946e6a8ea7534699462327f17b6b157e8e51d597b4ef228d698`, and Tabao `edf948ad99900fdb5f6e7c89197bd406ce21fc794c5c3862a4f4c5c2608e211e`.
