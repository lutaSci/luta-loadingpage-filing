...
test('APK delivery route logs only opaque aggregate-delivery fields', () => {
    ...
    assert.match(downloadCaddy, /mode 0600/)
    assert.match(downloadCaddy, /request>headers delete/)
    assert.match(downloadCaddy, /request>remote_ip delete/)
    assert.match(downloadCaddy, /request>client_ip delete/)
    assert.match(downloadCaddy, /request>uri delete/)
    ...
    assert.match(downloadCaddy, /log_append <range_header/)
