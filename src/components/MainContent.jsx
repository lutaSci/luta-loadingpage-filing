...
const MainContent = memo(() => {
    ...
    return (
        <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 pt-16 sm:pt-8 pb-24 md:pb-28" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 6rem)' }}>
            ...
            >
                {/* 标题 + 副标题 + 版本号 */}
                <motion.div {...fadeInUp} className="mb-4 md:mb-6">
                ...
                >
                    <div className="mx-auto mb-3 md:mb-4 relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56">
                        <motion.img
                            src={logo1}
                            alt="汝塔 Logo"
