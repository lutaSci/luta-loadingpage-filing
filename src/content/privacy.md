...
您可以选择“仅使用必要功能”，此时 Meta Pixel 不会加载，Google 广告存储保持关闭，官网浏览、下载和汝塔自身的确定性 Smart Link 归因仍可正常工作。您可随时通过页面左下角的“广告测量设置”修改或撤回选择；撤回后页面会重新加载，以停止后续广告测量事件。第三方接收方将按照其政策处理已收到的数据：Meta 隐私政策 https://www.facebook.com/privacy/policy/ ，Google 隐私政策 https://policies.google.com/privacy 。
