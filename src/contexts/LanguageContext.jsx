...
const translations = {
    zh: {
        ...
        iosWaitlistSteps: "iOS 白名单",
        iosWaitlistTitle: "加入 LUTA iOS 白名单",
        iosWaitlistDesc: "留下邮箱，我们会在 iOS 名单开放时通知你。",
        iosWaitlistCta: "加入白名单",
        iosWaitlistNote: "邮箱仅用于本次 iOS 加入通知。",
        iosWaitlistUnavailableCta: "白名单链接待配置",
    ...
    zhTW: {
        ...
        iosWaitlistSteps: "iOS 名單",
        iosWaitlistTitle: "加入 LUTA iOS 名單",
        iosWaitlistDesc: "留下電子郵件，我們會在 iOS 名單開放時通知你。",
        iosWaitlistCta: "加入名單",
        iosWaitlistNote: "電子郵件僅用於本次 iOS 加入通知。",
        iosWaitlistUnavailableCta: "名單連結待配置",
    ...
    en: {
        ...
        iosWaitlistSteps: "iOS list",
        iosWaitlistTitle: "Join the LUTA iOS list",
        iosWaitlistDesc: "Leave your email and we'll let you know when your iOS access is ready.",
        iosWaitlistCta: "Join the iOS list",
        iosWaitlistNote: "We'll only use your email for this iOS access notice.",
        iosWaitlistUnavailableCta: "List link pending",
    ...
    ja: {
        ...
        iosWaitlistSteps: "iOS案内リスト",
        iosWaitlistTitle: "LUTA iOS案内リストに登録",
        iosWaitlistDesc: "メールを残していただければ、iOSのご案内準備が整い次第お知らせします。",
        iosWaitlistCta: "iOSリストに登録",
        iosWaitlistNote: "メールアドレスは今回のiOSご案内のみに使用します。",
        iosWaitlistUnavailableCta: "リストリンク未設定",
    ...
    ko: {
        ...
        iosWaitlistSteps: "iOS 안내 명단",
        iosWaitlistTitle: "LUTA iOS 안내 명단 등록",
        iosWaitlistDesc: "이메일을 남겨주시면 iOS 이용 안내가 준비되는 대로 알려드릴게요.",
        iosWaitlistCta: "iOS 명단 등록",
        iosWaitlistNote: "이메일은 이번 iOS 안내 용도로만 사용합니다.",
        iosWaitlistUnavailableCta: "명단 링크 설정 대기 중",
