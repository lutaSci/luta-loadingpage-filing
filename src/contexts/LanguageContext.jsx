...
const translations = {
    zh: {
        ...
        iosWaitlistSteps: "海外 iOS 上架通知",
        iosWaitlistTitle: "海外 iOS 暂未开放下载",
        iosWaitlistDesc: "海外 App Store 版本正在重新上架。留下邮箱，上架后我们会第一时间通知你。",
        iosWaitlistCta: "留下邮箱，等待通知",
        iosWaitlistNote: "请在飞书表单中填写邮箱。我们只会用于上架通知。",
        iosWaitlistUnavailableCta: "表单链接待配置",
    ...
    zhTW: {
        ...
        iosWaitlistSteps: "海外 iOS 上架通知",
        iosWaitlistTitle: "海外 iOS 暫未開放下載",
        iosWaitlistDesc: "海外 App Store 版本正在重新上架。留下電子郵件，上架後我們會第一時間通知你。",
        iosWaitlistCta: "留下電子郵件，等待通知",
        iosWaitlistNote: "請在飛書表單中填寫電子郵件。我們只會用於上架通知。",
        iosWaitlistUnavailableCta: "表單連結待配置",
    ...
    en: {
        ...
        iosWaitlistSteps: "iOS waitlist",
        iosWaitlistTitle: "iOS is temporarily unavailable overseas",
        iosWaitlistDesc: "The overseas App Store version is being restored. Leave your email and we'll notify you as soon as it's available.",
        iosWaitlistCta: "Join the email waitlist",
        iosWaitlistNote: "Please enter your email in the Feishu form. We will only use it for the launch notification.",
        iosWaitlistUnavailableCta: "Form link pending",
    ...
    ja: {
        ...
        iosWaitlistSteps: "iOS事前通知",
        iosWaitlistTitle: "海外版iOSは現在ご利用いただけません",
        iosWaitlistDesc: "海外App Store版は再公開の準備中です。メールを残していただければ、公開後すぐにお知らせします。",
        iosWaitlistCta: "メールで通知を受け取る",
        iosWaitlistNote: "Feishuフォームにメールアドレスをご記入ください。公開通知のみに使用します。",
        iosWaitlistUnavailableCta: "フォームリンク未設定",
    ...
    ko: {
        ...
        iosWaitlistSteps: "iOS 대기 알림",
        iosWaitlistTitle: "해외 iOS 버전은 잠시 이용할 수 없습니다",
        iosWaitlistDesc: "해외 App Store 버전을 다시 준비하고 있습니다. 이메일을 남겨주시면 출시 후 바로 알려드릴게요.",
        iosWaitlistCta: "이메일 알림 신청",
        iosWaitlistNote: "Feishu 양식에 이메일을 입력해 주세요. 출시 알림 용도로만 사용합니다.",
        iosWaitlistUnavailableCta: "양식 링크 설정 대기 중",
