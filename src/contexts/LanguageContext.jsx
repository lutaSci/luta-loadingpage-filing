...
const translations = {
    zh: {
        ...
        iosStep1Title: "第1步 · 准备安装",
        iosStep1Desc: "请先下载苹果官方软件「TestFlight」，安装汝塔需要用到它",
        iosStep1Cta: "去下载 TestFlight",
        iosStep1Note: "下载后回到本页面即可，无需打开它",
        iosConfirmTitle: "即将前往 App Store",
        iosConfirmDo1: "下载后直接回到本页面",
        iosConfirmDo2: "点击第2步完成安装",
        iosConfirmDont: "无需打开 TestFlight（否则会弹出兑换码）",
        iosConfirmBtn: "好的，前往下载",
        iosStep2Title: "第2步 · 安装汝塔",
        iosStep2Desc: "点击按钮后按照提示完成安装",
        iosStep2Cta: "一键安装汝塔",
        iosStep2Note: "若弹出「兑换码」页面，请先关闭 TestFlight 再点击此按钮",
    ...
    zhTW: {
        ...
        iosStep1Title: "第1步 · 準備安裝",
        iosStep1Desc: "請先下載蘋果官方軟件「TestFlight」，安裝汝塔需要用到它",
        iosStep1Cta: "去下載 TestFlight",
        iosStep1Note: "下載後回到本頁面即可，無需打開它",
        iosConfirmTitle: "即將前往 App Store",
        iosConfirmDo1: "下載後直接回到本頁面",
        iosConfirmDo2: "點擊第2步完成安裝",
        iosConfirmDont: "無需打開 TestFlight（否則會彈出兌換碼）",
        iosConfirmBtn: "好的，前往下載",
        iosStep2Title: "第2步 · 安裝汝塔",
        iosStep2Desc: "點擊按鈕後按照提示完成安裝",
        iosStep2Cta: "一鍵安裝汝塔",
        iosStep2Note: "若彈出「兌換碼」頁面，請先關閉 TestFlight 再點擊此按鈕",
    ...
    en: {
        ...
        iosStep1Title: "Step 1 · Prepare to Install",
        iosStep1Desc: "Please download \"TestFlight\", Apple's official app — it's needed to install LUTA",
        iosStep1Cta: "Download TestFlight",
        iosStep1Note: "After downloading, return to this page. No need to open it",
        iosConfirmTitle: "Going to App Store",
        iosConfirmDo1: "Return to this page after download",
        iosConfirmDo2: "Tap Step 2 to complete installation",
        iosConfirmDont: "Don't open TestFlight (it will ask for a redeem code)",
        iosConfirmBtn: "OK, go download",
        iosStep2Title: "Step 2 · Install LUTA",
        iosStep2Desc: "Tap the button and follow the prompts to install",
        iosStep2Cta: "Install LUTA",
        iosStep2Note: "If a \"Redeem\" page appears, close TestFlight first, then tap this button again",
    ...
    ja: {
        ...
        iosStep1Title: "ステップ1 · インストール準備",
        iosStep1Desc: "Apple公式アプリ「TestFlight」を先にダウンロードしてください。LUTAのインストールに必要です",
        iosStep1Cta: "TestFlight をダウンロード",
        iosStep1Note: "ダウンロード後はこのページに戻ってください。開く必要はありません",
        iosConfirmTitle: "App Storeに移動します",
        iosConfirmDo1: "ダウンロード後このページに戻る",
        iosConfirmDo2: "ステップ2をタップしてインストール",
        iosConfirmDont: "TestFlightを開かないでください（コード入力画面が出ます）",
        iosConfirmBtn: "了解、ダウンロードへ",
        iosStep2Title: "ステップ2 · LUTAをインストール",
        iosStep2Desc: "ボタンをタップし、案内に従ってインストールしてください",
        iosStep2Cta: "LUTAをインストール",
        iosStep2Note: "「コードを入力」画面が出た場合は、TestFlightを閉じてこのボタンを再度タップしてください",
    ...
    ko: {
        ...
        iosStep1Title: "1단계 · 설치 준비",
        iosStep1Desc: "Apple 공식 앱 \"TestFlight\"를 먼저 다운로드해 주세요. LUTA 설치에 필요합니다",
        iosStep1Cta: "TestFlight 다운로드",
        iosStep1Note: "다운로드 후 이 페이지로 돌아와 주세요. 열 필요 없습니다",
        iosConfirmTitle: "App Store로 이동합니다",
        iosConfirmDo1: "다운로드 후 이 페이지로 돌아오기",
        iosConfirmDo2: "2단계를 눌러 설치 완료",
        iosConfirmDont: "TestFlight를 열지 마세요 (코드 입력 화면이 나옵니다)",
        iosConfirmBtn: "네, 다운로드하기",
        iosStep2Title: "2단계 · LUTA 설치",
        iosStep2Desc: "버튼을 누른 후 안내에 따라 설치하세요",
        iosStep2Cta: "LUTA 설치하기",
        iosStep2Note: "\"코드 입력\" 화면이 나타나면, TestFlight를 닫고 이 버튼을 다시 눌러주세요",
